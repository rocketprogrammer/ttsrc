...
class CatalogWindowItem(CatalogAtticItem.CatalogAtticItem):
    ...
    def getPicture(self, avatar):
        ...
        cpa = ClipPlaneAttrib.make(ClipPlaneAttrib.OAdd, clipperLeft, clipperRight, clipperTop, clipperBottom)
        model.node().setAttrib(cpa)
        frame.attachNewNode(clipperLeft)
        frame.attachNewNode(clipperRight)
        frame.attachNewNode(clipperTop)
        frame.attachNewNode(clipperBottom)
