    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        self.fsm = ClassicFSM.ClassicFSM('CogHQBossBattle', [
         ...
         State.State('finalBattle', self.enterFinalBattle, self.exitFinalBattle, [
          'walk', 'stickerBook', 'teleportOut', 'died', 'tunnelOut', 'DFA', 'battle', 'movie', 'ouch', 'crane', 'WaitForBattle']),
         ...
         State.State('crane', self.enterCrane, self.exitCrane, [
          'walk', 'battle', 'finalBattle', 'died', 'ouch']),
         State.State('walk', self.enterWalk, self.exitWalk, [
          'stickerBook', 'teleportOut', 'died', 'tunnelOut', 'DFA', 'battle', 'movie', 'ouch', 'crane', 'finalBattle', 'WaitForBattle']),
