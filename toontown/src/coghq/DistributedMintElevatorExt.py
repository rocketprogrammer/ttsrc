...
class DistributedMintElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setBldgDoId(self, bldgDoId):
        # The doId is junk, there is no building object for the mint
    ...
    def rejectBoard(self, avId, reason = 0):
        ...
        # see also: DistributedMintElevatorExtAI.avIsOKToBoard

        DistributedElevatorExt.DistributedElevatorExt.rejectBoard(self,
                                                                  avId, reason)
        return
