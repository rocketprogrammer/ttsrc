...
class DistributedMintElevatorExt(DistributedElevatorExt.DistributedElevatorExt):
    ...
    def setMintId(self, mintId):
        self.mintId = mintId
        mintId2originId = {ToontownGlobals.CashbotMintIntA: 1, ToontownGlobals.CashbotMintIntB: 2, ToontownGlobals.CashbotMintIntC: 0}
    ...
    def setMintInteriorZone(self, zoneId):
        if self.localToonOnBoard:
            ...
            doneStatus = {'loader': 'cogHQLoader', 'where': 'mintInterior', 'how': 'teleportIn', 'zoneId': zoneId, 'mintId': self.mintId, 'hoodId': hoodId}
