...
from toontown.toonbase import TTLocalizer as Localizer
...
class Quest:
    ...
    def checkLocation(self, location):
        locations = [Anywhere] + Localizer.GlobalStreetNames.keys()
...
class LocationBasedQuest(Quest):
    ...
    def getLocationName(self):
        ...
        if loc == Anywhere:
            ...
            if loc in ToontownGlobals.Hoods:
                locName = Localizer.QuestPosterLocationIn + ToontownGlobals.hoodNameMap[loc][1]
            else:
                if loc in ToontownGlobals.StreetBranchZones:
    ...
    def isLocationMatch(self, zoneId):
        ...
        if ZoneUtil.isPlayground(loc):
            ...
            if loc == ZoneUtil.getBranchZone(zoneId):
                return 1
            else:
                if loc == zoneId:
                    return 1
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumCogs() == 1:
                ...
                return Localizer.QuestsCogQuestProgress % {'progress': questDesc[4], 'numCogs': self.getNumCogs()}
...
class CogTrackQuest(CogQuest):
    __module__ = __name__
    trackCodes = ['c', 'l', 'm', 's']
    trackNamesS = [Localizer.BossbotS, Localizer.LawbotS, Localizer.CashbotS, Localizer.SellbotS]
    trackNamesP = [
     Localizer.BossbotP, Localizer.LawbotP, Localizer.CashbotP, Localizer.SellbotP]
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumCogs() == 1:
                ...
                return Localizer.QuestsCogTrackQuestProgress % {'progress': questDesc[4], 'numCogs': self.getNumCogs()}
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        return Localizer.QuestsCogTrackQuestQTString % {'cogText': cogText, 'cogLoc': cogLocName}
...
class CogLevelQuest(CogQuest):
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumCogs() == 1:
                ...
                return Localizer.QuestsCogLevelQuestProgress % {'progress': questDesc[4], 'numCogs': self.getNumCogs()}
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        return Localizer.QuestsCogLevelQuestQTString % {'objective': objective, 'location': location}
...
class BuildingQuest(CogQuest):
    __module__ = __name__
    trackCodes = ['c', 'l', 'm', 's']
    trackNames = [Localizer.Bossbot, Localizer.Lawbot, Localizer.Cashbot, Localizer.Sellbot]
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumBuildings() == 1:
                ...
                return Localizer.QuestsBuildingQuestProgressString % {'progress': questDesc[4], 'num': self.getNumBuildings()}
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        location = self.getLocationName()
        return Localizer.QuestsBuildingQuestQTString % {'objective': objective, 'location': location}
...
class DeliverGagQuest(Quest):
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumGags() == 1:
                ...
                return Localizer.QuestsDeliverGagQuestProgress % {'progress': questDesc[4], 'numGags': self.getNumGags()}
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        if num == 1:
            ...
            gagName = ToontownBattleGlobals.AvPropStringsPlural[track][item]
        return [text % {'gagName': gagName}, Localizer.QuestsDeliverGagQuestQTString] + getVisitQTStrings(toNpcId)
...
class DeliverItemQuest(Quest):
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        itemName = iDict[0]
        return [
         Localizer.QuestsDeliverItemQuestQTString % {'article': article, 'itemName': itemName}] + getVisitQTStrings(toNpcId)
...
class RecoverItemQuest(LocationBasedQuest):
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumItems() == 1:
                ...
                return Localizer.QuestsRecoverItemQuestProgress % {'progress': questDesc[4], 'numItems': self.getNumItems()}
    ...
    def getString(self):
        return Localizer.QuestsRecoverItemQuestString % {'item': self.getObjectiveStrings()[0], 'holder': self.getObjectiveStrings()[1]}
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        if progress >= self.getNumItems():
            ...
            if toNpcId == ToonHQ:
                strings = [
                 Localizer.QuestsRecoverItemQuestReturnToHQQTString % itemName, Localizer.QuestsRecoverItemQuestGoToHQQTString]
            else:
                if toNpcId:
                    npcName, hoodName, buildingName, streetName = getNpcInfo(toNpcId)
                    strings = [Localizer.QuestsRecoverItemQuestReturnToQTString % {'item': itemName, 'npcName': npcName}]
                    if streetName == 'Playground':
                        strings.append(Localizer.QuestsRecoverItemQuestGoToPlaygroundQTString % hoodName)
                    else:
                        strings.append(Localizer.QuestsRecoverItemQuestGoToStreetQTString % {'street': streetName, 'hood': hoodName})
                    strings.extend([Localizer.QuestsRecoverItemQuestVisitBuildingQTString % buildingName, Localizer.QuestsRecoverItemQuestWhereIsBuildingQTString % buildingName])
            return strings
        holder = self.getHolder()
        holderType = self.getHolderType()
        ...
        return Localizer.QuestsRecoverItemQuestRecoverFromQTString % {'item': itemName, 'holder': holderName, 'loc': locName}
...
class TrackChoiceQuest(Quest):
    ...
    def getString(self):
        return Localizer.QuestsTrackChoiceQuestString % {'trackA': self.getObjectiveStrings()[0], 'trackB': self.getObjectiveStrings()[1]}
    ...
    def getQTStrings(self, toNpcId, progress):
        ...
        trackBName = ToontownBattleGlobals.Tracks[trackB].capitalize()
        return [
         Localizer.QuestsTrackChoiceQuestQTString % {'trackA': trackAName, 'trackB': trackBName}, Localizer.QuestsTrackChoiceQuestMaybeQTString % trackAName, Localizer.QuestsTrackChoiceQuestMaybeQTString % trackBName] + getVisitQTStrings(toNpcId)
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumFriends() == 1:
                ...
                return Localizer.QuestsFriendNewbieQuestProgress % {'progress': questDesc[4], 'numFriends': self.getNumFriends()}
    ...
    def getProgressString(self, avatar, questDesc):
        if self.getCompletionStatus(avatar, questDesc) == COMPLETE:
            ...
            if self.getNumMinigames() == 1:
                ...
                return Localizer.QuestsMinigameNewbieQuestProgress % {'progress': questDesc[4], 'numMinigames': self.getNumMinigames()}
...
DefaultDialog = {GREETING: DefaultGreeting, QUEST: DefaultQuest, INCOMPLETE: DefaultIncomplete, INCOMPLETE_PROGRESS: DefaultIncompleteProgress, INCOMPLETE_WRONG_NPC: DefaultIncompleteWrongNPC, COMPLETE: DefaultComplete, LEAVING: DefaultLeaving}
    ...
    for questId in QuestDict.keys():
        if isStartingQuest(questId):
            if tier is None:
                ...
                if questId in Tier2QuestsDict[tier]:
                    startingQuests.append(questId)
        ...
        if tier == BR_TIER:
            if trackAccess[ToontownBattleGlobals.TRAP_TRACK] == 1:
                ...
                if trackAccess[ToontownBattleGlobals.SOUND_TRACK] == 0:
                    ...
                    if trackAccess[ToontownBattleGlobals.HEAL_TRACK] == 0:
                        bestQuest = 5006
                    else:
                        if trackAccess[ToontownBattleGlobals.DROP_TRACK] == 0:
                            bestQuest = 5007
                        else:
                            if trackAccess[ToontownBattleGlobals.LURE_TRACK] == 0:
                                bestQuest = 5008
                            else:
                                notify.warning('av %s has bogus trackAccess: %s' % (av.getDoId(), trackAccess))
                                return fixAndCallAgain()
...
def getVisitQTStrings(npcId):
    if npcId == ToonHQ:
        strings = [
         'I need to see an HQ Officer.', 'I need to go to a Toon HQ.']
    else:
        if npcId == ToonTailor:
            strings = [
...
def getNpcInfo(npcId):
    ...
    return (
     npcName, hoodName, buildingName, streetName)
...
def getNpcLocationDialog(fromNpcId, toNpcId):
    ...
    paragraph = Localizer.QuestsLocationParagraph % {'building': Localizer.QuestsLocationBuilding % toNpcName, 'buildingName': toBuildingName, 'buildingVerb': Localizer.QuestsLocationBuildingVerb, 'street': streetDesc}
    return (
     paragraph, toBuildingName, streetDesc)
    return
...
class MaxGagCarryReward(Reward):
    ...
    def getString(self):
        name = self.getName()
        amt = self.getAmount()
        return Localizer.QuestsMaxGagCarryReward % {'name': name, 'num': amt}

    def getPosterString(self):
        name = self.getName()
        amt = self.getAmount()
        return Localizer.QuestsMaxGagCarryRewardPoster % {'name': name, 'num': amt}
...
TrackTrainingQuotas = {ToontownBattleGlobals.HEAL_TRACK: 15, ToontownBattleGlobals.TRAP_TRACK: 15, ToontownBattleGlobals.LURE_TRACK: 15, ToontownBattleGlobals.SOUND_TRACK: 15, ToontownBattleGlobals.THROW_TRACK: 15, ToontownBattleGlobals.SQUIRT_TRACK: 15, ToontownBattleGlobals.DROP_TRACK: 15}
...
class TrackProgressReward(Reward):
    ...
    def getString(self):
        trackName = ToontownBattleGlobals.Tracks[self.getTrack()].capitalize()
        return Localizer.QuestsTrackProgressReward % {'frameNum': self.getProgressIndex(), 'trackName': trackName}

    def getPosterString(self):
        trackName = ToontownBattleGlobals.Tracks[self.getTrack()].capitalize()
        return Localizer.QuestsTrackProgressRewardPoster % {'trackName': trackName, 'frameNum': self.getProgressIndex()}
...
class CheesyEffectReward(Reward):
    ...
    def getString(self):
        ...
        if duration:
            ...
            return Localizer.CheesyEffectIndefinite % {'effectName': desc, 'whileIn': whileStr}
...
def checkReward(questId, forked=0):
    ...
    if nextQuests is None:
        validRewards = RewardDict.keys() + [Any, OBSOLETE]
