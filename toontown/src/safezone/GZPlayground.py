...
class GZPlayground(Playground.Playground):
    ...
    def enterStartingBlock(self, distStartingBlock):
        ...
        self.accept(self.golfKartBlockDoneEvent, self.handleStartingBlockDone)
        self.golfKartBlock = Elevator.Elevator(self.fsm.getStateNamed("golfKartBlock"),
                                               self.golfKartBlockDoneEvent,
                                               distStartingBlock)
        distStartingBlock.elevatorFSM=self.golfKartBlock
        self.golfKartBlock.load()
        self.golfKartBlock.enter()

    def exitStartingBlock(self):
        assert(self.notify.debug("exitStartingBlock()"))
        self.ignore(self.golfKartBlockDoneEvent)
        self.golfKartBlock.unload()
