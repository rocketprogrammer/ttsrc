...
class GardenPage(ShtikerPage.ShtikerPage):
    """
    GardenPage keeps track of flowers picked and their names.
    """
    ...
    def __init__(self):
        """
        GardenPage constructor: create the garden page
        """
        ...
        if len(specialsList) == 0:
            ...
            for entry in specialsList:
                ...
                someItem = DirectScrolledListItem(
                    ...
                    text = ("%s x %s" % (GardenGlobals.Specials[entry[0]]['photoName'], entry[1])),
                    text_align = TextNode.ALeft,
    ...
    def destroy(self):
        ...
        #guessing DirectFrame.destroy will also call these
        #self.basketTab.destroy()
        #self.collectionTab.destroy()
        #self.trophyTab.destroy()
        #if hasattr(self, "browser"):
...
class GardenTrophy(DirectFrame):
    ...
    def __init__(self, level):
        ...
        """
        self.allGardenTrophies = loader.loadModel("phase_5.5/models/estate/gardenTrophies")
        self.allGardenTrophies.reparentTo(self)
        self.gardenTrophies = []
        ...
        for index in range(4):
            ...
            findStr += letter
            tempTrophy = self.allGardenTrophies.find("**/%s" % findStr)
            tempTrophy.setScale(0.75)
            tempTrophy.reparentTo(self)
            self.gardenTrophies.append(tempTrophy)
    ...
    def setLevel(self, level):
        ...
        #just put them in order of height
        order = ('C','D','B','A')
