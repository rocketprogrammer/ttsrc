...
def createGoonExplosion(parent, explosionPoint, scale):
    ...
    return Parallel(explosion, SoundInterval(deathSound), ParticleInterval(smallGearExplosion, deathNode, worldRelative=0, duration=4.3), ParticleInterval(bigGearExplosion, deathNode, worldRelative=0, duration=1.0), name='gears2MTrack')