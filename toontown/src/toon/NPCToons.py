...
NPCToonDict = {
    ...
    5305 : (5804, lnames[5305],("hls" ,"ss" ,"l" ,"f" ,4 ,0 ,4 ,4 ,1 ,21 ,1 ,21 ,16 ,27 ,), "f", 0, NPC_REGULAR), # ("Just Vase It", ""),
    5306 : (5805, lnames[5306], "r", "m", 0, NPC_REGULAR), # ("Snail Mail", ""),
    5307 : (5809, lnames[5307],("css" ,"ms" ,"l" ,"m" ,12 ,0 ,12 ,12 ,1 ,9 ,1 ,9 ,1 ,2 ,), "m", 0, NPC_REGULAR), # ("Fungi Clown School", ""),
    5308 : (5810, lnames[5308],("cls" ,"ms" ,"l" ,"f" ,4 ,0 ,4 ,4 ,1 ,22 ,1 ,22 ,10 ,27 ,), "f", 0, NPC_REGULAR), # ("Honeydew This", ""),
    5309 : (5811, lnames[5309], "r", "f", 0, NPC_REGULAR), # ("Lettuce Inn", ""),
    5310 : (5815, lnames[5310],("dls" ,"ms" ,"l" ,"m" ,12 ,0 ,12 ,12 ,0 ,11 ,0 ,11 ,1 ,14 ,), "m", 0, NPC_REGULAR), # ("Grass Roots", ""),
    5311 : (5817, lnames[5311],("fll" ,"ms" ,"m" ,"f" ,3 ,0 ,3 ,3 ,0 ,24 ,0 ,24 ,12 ,27 ,), "f", 0, NPC_REGULAR), # ("Apples and Oranges", ""),
    5312 : (5819, lnames[5312],("fss" ,"ss" ,"m" ,"m" ,18 ,0 ,18 ,18 ,0 ,12 ,0 ,12 ,1 ,6 ,), "m", 0, NPC_REGULAR), # ("Green Bean Jeans", ""),
    5313 : (5821, lnames[5313],("fls" ,"ls" ,"m" ,"m" ,10 ,0 ,10 ,10 ,0 ,12 ,0 ,12 ,1 ,1 ,), "m", 0, NPC_REGULAR), # ("Squash and Stretch Gym", ""),
    5314 : (5826, lnames[5314], "r", "f", 0, NPC_REGULAR), # ("Ant Farming Supplies", ""),
    5315 : (5827, lnames[5315],("rss" ,"ss" ,"m" ,"m" ,18 ,0 ,18 ,18 ,1 ,12 ,1 ,12 ,1 ,16 ,), "m", 0, NPC_REGULAR), # ("Dirt. Cheap.", ""),
    5316 : (5828, lnames[5316],("mss" ,"ls" ,"m" ,"m" ,10 ,0 ,10 ,10 ,1 ,12 ,1 ,12 ,1 ,13 ,), "m", 0, NPC_REGULAR), # ("Couch Potato Furniture", ""),
    5317 : (5830, lnames[5317], "r", "m", 0, NPC_REGULAR), # ("Spill the Beans", ""),
    5318 : (5833, lnames[5318],("hsl" ,"ss" ,"m" ,"m" ,18 ,0 ,18 ,18 ,1 ,0 ,1 ,0 ,1 ,4 ,), "m", 0, NPC_REGULAR), # ("The Salad Bar", ""),
    5319 : (5835, lnames[5319], "r", "f", 0, NPC_REGULAR), # ("Flower Bed and Breakfast", ""),
    5320 : (5836, lnames[5320],("cll" ,"sd" ,"m" ,"f" ,2 ,0 ,2 ,2 ,1 ,1 ,1 ,1 ,17 ,27 ,), "f", 0, NPC_REGULAR), # ("April's Showers and Tubs", ""),
    5321 : (5837, lnames[5321],("css" ,"ms" ,"m" ,"f" ,18 ,0 ,18 ,18 ,1 ,1 ,1 ,1 ,17 ,27 ,), "f", 0, NPC_REGULAR), # ("School of Vine Arts", ""),
